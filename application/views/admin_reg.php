<?php
	...
	echo form_open(base_url() . 'admin_user/register_admin');
...
<div class="top" align="center" style="border-style:solid; border-color:#B7DDF2; background-color: #7B7A79; height:20px; width:366px;"><font color="#FFFFFF" face="Arial">Admin Registration</font></div>
